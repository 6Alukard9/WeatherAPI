...
def get_weather():
    try:
        ...
        # Weather API
        api = 'https://api.openweathermap.org/data/2.5/weather?q='+city+'&appid=4196bb928d4429eb9d55811ededadf64'
...
# Search box
Search_image = PhotoImage(file=r'.\images\search.png')
...
Search_icon = PhotoImage(file=r'.\images\search_icon.png')
...
# Bottom box
Frame_image = PhotoImage(file=r'.\images\box.png')
